...
const Package = (props) => {
    ...
    return (
        <div className=' lg:mt-10 shadow-2xl border hover:border-yellow-400 h-full rounded-2xl transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105'>
            <div>
                <div className="h-4/5">
                    <div>
                    ...
                    <div className='p-3 h-80'>
                        <div >
                            ...
                            <p className='font-normal h-24 overflow-hidden'><span></span>{Description}</p>
