            ...
            <div>
                ...
                <div className='border-2 px-10 py-16 m-10 rounded-lg'>
                    <div>
                        ...
                        <p>Don't have an account? <a href="https://accounts.google.com/signup/v2/webcreateaccount?hl=en&flowName=GlifWebSignIn&flowEntry=SignUp" className='text-blue-400 border-b  border-blue-300'>Create an account</a> </p>
                    </div>
                </div>
            </div>
        </div>
